		...
		try {
			resp = await config.fetch(url, {
				...
				headers: {
					...
					"User-Agent": config.userAgent || `anthropic-sdk-typescript/0.107.0 oidcFederationProvider`
				},
				body: JSON.stringify(body)
			});
		} catch (err) {
		...
		try {
			resp = await config.fetch(url, {
				...
				headers: {
					...
					"User-Agent": config.userAgent || `anthropic-sdk-typescript/0.107.0 userOAuthProvider`
				},
				body: JSON.stringify(body)
			});
		} catch (err) {
...
//#endregion
//#region node_modules/unenv/dist/runtime/node/internal/readline/interface.mjs
...
//#endregion
//#region node_modules/unenv/dist/runtime/node/readline.mjs
